/*!
 * @file Waveshare_LCD1602RGB.h
 * @brief Waveshare_LCD1602RGB class infrastructure
...
#ifndef __Waveshare_LCD1602RGB_H__
#define __Waveshare_LCD1602RGB_H__
#include<Arduino.h>
#include <Wire.h>
#include <inttypes.h>
#include "Print.h"
...
class Waveshare_LCD1602RGB : public Print 
{
...
public:
   ...
   *  @brief Constructor
   */
  Waveshare_LCD1602RGB(uint8_t lcdCols,uint8_t lcdRows,TwoWire *pWire=&Wire,uint8_t lcdAddr=LCD_ADDRESS,uint8_t RGBAddr=RGB_ADDRESS);
